 ...
 */
metadata {
    definition (name: "vThing Dimmer", namespace: "tmlong", author: "Todd Long") {
        capability "Actuator"
        capability "Refresh"
        capability "Switch"
    ...
    tiles(scale: 2) {
        standardTile("main", "device.switch") {
            state "on", label: "on", action: "switch.off", icon: "st.lights.multi-light-bulb-off", backgroundColor: "#00A0DC", nextState: "turningOff"
            state "off", label: "off", action: "switch.on", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#ffffff", nextState: "turningOn"
            state "someOn", label: "some on", action: "switch.off", icon: "st.lights.multi-light-bulb-off", backgroundColor: "#79b821", nextState: "turningOff"
            state "turningOn", label: "turning on", action: "switch.off", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#00A0DC", nextState: "turningOff"
            state "turningOff", label: "turning off", action: "switch.on", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#ffffff", nextState: "turningOn"
        }

        multiAttributeTile(name: "details", type: "generic", width: 6, height: 4) {
            tileAttribute("device.switch", key: "PRIMARY_CONTROL") {
                attributeState "on", label: "on", action: "switch.off", icon: "st.lights.multi-light-bulb-off", backgroundColor: "#00A0DC", nextState: "turningOff"
                attributeState "off", label: "off", action: "switch.on", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#ffffff", nextState: "turningOn"
                attributeState "someOn", label: "on", action: "switch.off", icon: "st.lights.multi-light-bulb-off", backgroundColor: "#79b821", nextState: "turningOff"
                attributeState "turningOn", label: "...", action: "switch.off", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#00A0DC", nextState: "turningOff"
                attributeState "turningOff", label: "...", action: "switch.on", icon: "st.lights.multi-light-bulb-on", backgroundColor: "#ffffff", nextState: "turningOn"
            }
